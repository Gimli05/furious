...
public abstract class TrainElement {
	protected Color color; /* Az adott elem színe. A mozdonyok csakis fekete színnel léteznek, míg a kabinoknak saját színe van. 
	...
	public Color getColor(){
		System.out.println("Class: TrainElement\t Object: "+this+"\t Method: getColor\t");
		System.out.println("Class: TrainElement\t Object: "+this+"\t Returned: "+color);
		return color;
	}
}
